...
public class espc_IonAccumulatorEffectOld implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin, WeaponEffectPluginWithInit,
	OnHitEffectPlugin{
	...
	public void init(WeaponAPI weapon) {
		...
		for (WeaponAPI wep : ship.getAllWeapons()) {
			if (wep.getEffectPlugin() != null && wep.getEffectPlugin() instanceof espc_IonAccumulatorEffectOld &&
				((espc_IonAccumulatorEffectOld) wep.getEffectPlugin()).getPlugin() != null) {
				plugin = ((espc_IonAccumulatorEffectOld) wep.getEffectPlugin()).getPlugin();
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit,
		...
		if (!shieldHit) {
			...
			((espc_IonAccumulatorEffectOld) thisWep.getEffectPlugin()).projs.addLast(
