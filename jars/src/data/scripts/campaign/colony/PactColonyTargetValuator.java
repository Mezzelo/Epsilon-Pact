package data.scripts.campaign.colony;
...
public class PactColonyTargetValuator {
	...
	public boolean prefilterSystem(StarSystemAPI system, FactionAPI faction) {
		...
		if (!inhabited) {
			for (CampaignFleetAPI fleet : system.getFleets()) {
				...
				if (fleet.isStationMode() && !fleet.getFaction().getId().equals("remnant") &&
					!fleet.getFaction().getId().equals("derelict")) return false;
