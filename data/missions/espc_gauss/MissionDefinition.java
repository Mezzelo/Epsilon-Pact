...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		PersonAPI pilot = EspcOfficerFactory.MakePilot("Gauss", "", FullName.Gender.FEMALE, "reckless", 
			...
			public void advance(float amount, List events) {
				if (!didSpawns) {
					...
					for (FleetMemberAPI thisShip : fleetManager.getReservesCopy()) {
						...
						} else if (hullName.equals("Atlas Mk.II")) {
							fleetManager.spawnFleetMember(thisShip, new Vector2f(1500f, 7000f), 270f, 4f);
						} else if (hullName.equals("Eradicator (P)")) {
